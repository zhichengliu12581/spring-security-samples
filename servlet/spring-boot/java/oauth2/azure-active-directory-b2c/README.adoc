...
Sample project: <<./web-application-1-simple-sample/README.adoc#link-value, web-application-1-simple-sample>>
...
Sample project: <<./web-application-2-with-scopes/README.adoc#link-value, web-application-2-with-scopes>>
...
Sample project: <<./web-application-3-with-client-credentials/README.adoc#link-value, web-application-3-with-client-credentials>>
...
Sample project: <<./web-application-4-with-additional-parameters/README.adoc#link-value, web-application-4-with-additional-parameters>>
...
Sample project: <<./resource-server-1-simple-sample/README.adoc#link-value, resource-server-1-simple-sample>>
...
Sample project: <<./resource-server-2-validate-audience/README.adoc#link-value, resource-server-2-validate-audience>>
...
Sample project: <<./resource-server-3-authorize-by-scopes/README.adoc#link-value, resource-server-3-authorize-by-scopes>>
...
Sample project: <<./resource-server-4-authorize-by-app-roles/README.adoc#link-value, resource-server-4-authorize-by-app-roles>>
...
Sample project: <<./resource-server-5-multi-tenant/README.adoc#link-value, resource-server-5-multi-tenant>>
