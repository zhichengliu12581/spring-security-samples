...
Sample project: <<./web-application-1-simple-sample/README.adoc, web-application-1-simple-sample>>
...
Sample project: <<./web-application-2-with-scopes/README.adoc, web-application-2-with-scopes>>
...
Sample project: <<./web-application-3-with-client-credentials/README.adoc, web-application-3-with-client-credentials>>
...
Sample project: <<./web-application-4-with-additional-parameters/README.adoc, web-application-4-with-additional-parameters>>
...
Sample project: <<./resource-server-1-simple-sample/README.adoc, resource-server-1-simple-sample>>
...
Sample project: <<./resource-server-2-validate-audience/README.adoc, resource-server-2-validate-audience>>
...
Sample project: <<./resource-server-3-authorize-by-scopes/README.adoc, resource-server-3-authorize-by-scopes>>
...
Sample project: <<./resource-server-4-authorize-by-app-roles/README.adoc, resource-server-4-authorize-by-app-roles>>
...
Sample project: <<./resource-server-5-multi-tenant/README.adoc, resource-server-5-multi-tenant>>
